# src/semiSL_recognition/evaluate_and_predict.py
import sys
...
def evaluate_on_validation(
    model_path="results/semiSL_recognition/character_classifier.pth",
    yolo_model_path="results/yolo/yolo_runs/detect/character_detection2/weights/best.pt",
    dataset_path="dataset",
    output_dir="results/semiSL_recognition/evaluate_and_predict",
):
...
def generate_test_predictions(
    ...
    output_file="results/semiSL_recognition/evaluate_and_predict/expression_predictions.csv",
    conf_threshold=0.5,
):
...
def visualize_expression_semiSL_recognition(
    model_path="results/semiSL_recognition/character_classifier.pth",
    yolo_model_path="results/yolo/yolo_runs/detect/character_detection2/weights/best.pt",
    dataset_path="dataset",
    num_samples=5,
):
    """Visualize complete expression semiSL_recognition pipeline"""
    ...
    plt.tight_layout()
    plt.savefig(
        "results/semiSL_recognition//evaluate_and_predict/expression_semiSL_recognition_demo.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.show()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--visualize", action="store_true", help="Visualize semiSL_recognition"
    )
    parser.add_argument(
        "--model", default="results/semiSL_recognition/character_classifier.pth"
    )
    parser.add_argument(
        "--yolo",
    ...
    if args.visualize:
        visualize_expression_semiSL_recognition(
            model_path=args.model, yolo_model_path=args.yolo
        )
